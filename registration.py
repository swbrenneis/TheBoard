...
class NewUserDialog(QDialog):
    ...
    def setUpWindow(self):
        """ Create and arrange the widgets in the window for
        ...
        # Create name QLabel and QlineEdt widgets
        ...
        # Create password QName and QLineEdt widgets
    ...
    def confirmSignUp(self):
        ...
        if name_text == "" or pswd_text == "":
            # Display QMessageBox if username or password is empty
            QMessageBox.warning(self, "Error Message",
                                "Please enter username and password values",
